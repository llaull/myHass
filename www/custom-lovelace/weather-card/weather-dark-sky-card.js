...
//    var icons = this.config.static_icons ? "static" : "animated";
    var currentText = this.config.entity_current_text ? html`<span class="currentText" id="current-text">${this._hass.states[this.config.entity_current_text].state}</span>` : html`<span class="currentText" id="current-text">Ozamiz</span>`;
...
// Build HTML    
    return html`
      ...
      <ha-card class = "card">  
        <span class="icon bigger" id="icon-bigger" style="background: none, url(/local/custom-lovelace/weather-card/icones/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this.current.conditions]}.svg) no-repeat; background-size: contain;">${this.current.conditions}</span>
            ...
            <div class="forecast clear">
              ${this.forecast.map(daily => html`
                <div class="day fcasttooltip">
                  ...
                  <br><i class="icon" id="fcast-icon-${daily.dayIndex}" style="background: none, url(/local/custom-lovelace/weather-card/icones/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this._hass.states[daily.condition].state]}.svg) no-repeat; background-size: contain;"></i>
...
// Current Conditions
      ...
      root.getElementById("icon-bigger").style.backgroundImage = `none, url(/local/custom-lovelace/weather-card/icones/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this.current.conditions]}.svg)`;
...
// Forecast blocks
      this.forecast.forEach((daily) => {
        ...
        root.getElementById("fcast-icon-" + daily.dayIndex).style.backgroundImage = `none, url(/local/custom-lovelace/weather-card/icones/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this._hass.states[daily.condition].state]}.svg`;
